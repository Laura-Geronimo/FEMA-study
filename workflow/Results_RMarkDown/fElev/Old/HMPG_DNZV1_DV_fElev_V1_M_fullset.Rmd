...
The correlation matrix indicates corr between:
  -TotPop: and TotHU (0.97), and Taxbase (0.75)
  -MHI: and MHV (0.72)
  -Tax base: and TotPop (0.75), mHV(0.63),TotHU (0.78)
...
seeLev <- DNZV1[c(24,33,3463,1967,1025,4397,339),]
...
```{r include= FALSE}
DNZV1_unLev <- DNZV1[c(-24,-33,-3463,-1967,-1025,-4397,-339),]
