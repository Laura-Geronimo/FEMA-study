...
for (name in names_list) {
  DNZV1$namedStorm[DNZV1$declarationTitle %like% name] <- name
}

table(DNZV1$namedStorm)
```
...
summary(aov(felev ~ mrp_ideology, data = DNZV1)) #low sig *
...
columns <- c("TotPop_10k", "PopDense_1k", "fWhite", "fBlack", "fHisp", "MHIadj_10k", "MHVadj_100k", "TotHU_10k", "TotOccHU_10k", "RepRate", "mrp_ideology", "fOwnOcc", "fRentOcc", "fS2ndHome", "TaxBaseEst_1B", "ZCTA_shore", "count_fema_sfha_1k", "count_fs_risk_500_year00_1k", "NFIP_ICCadj_YOLZ_1M", "NFIP_AllClaimsAdj_YOLZ_10M", "IHP_fldDamAmountAdjDNZ_10M", "Hurricane")
...
M11 <- create_error_plot(DNZV1, "mrp_ideology_dec", "felev", "Dec: MPR Ideology")
...
library(gridExtra)
grid.arrange(M1,M2,M3,M4,M5,M6,M7,M8,M9,M10,M11,M12,M13,M14,M15,M17,M18,M19,M20,M21, ncol=3)
...
L11 <- create_scatter_plot(DNZV1, mrp_ideology, felev, "MPR Ideology")
...
library(gridExtra)
grid.arrange(L1,L2,L3,L4,L5,L6,L7,L8,L9,L10,L11,L12,L13,L14,L15,L16,L17,L18,L19,L20,L21, ncol=3)
...
summary(aov(felev ~ mrp_ideology, data = DNZV1_ZCTA_shore)) #sig ***
...
M11 <- create_error_plot(DNZV1_ZCTA_shore, "mrp_ideology_dec", "felev", "Dec: MPR Ideology")
...
L11 <- create_scatter_plot(DNZV1_ZCTA_shore, mrp_ideology, felev, "MPR Ideology")
...
library(gridExtra)
grid.arrange(L1,L2,L3,L4,L5,L6,L7,L8,L9,L10,L11,L12,L13,L14,L15,L17,L18,L19,L20,L21, ncol=3)
