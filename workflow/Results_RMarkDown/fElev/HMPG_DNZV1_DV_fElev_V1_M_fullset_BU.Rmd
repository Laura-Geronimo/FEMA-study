...
```{r include=FALSE}
fs_vars_V1 <- DNZV1[,c("TotPop_W_10k",          #Stepwise, SVSS
                       "PopDense_W_1k",         #ANOVA
                       "fWhite",                #ANOVA, SVSS
                       "fHisp",                 #stepwise
                       "MHIadj_W_10k",          #ANOVA, stepwise
                       "MHVadj_W_100k",         #ANOVA, stepwise, SVSS
                       "TotOccHU_W_10k",        #SVSS
                       "TotHU_W_10k",           #stepwise
                       "mrp_ideology",          #SVSS
                       "TaxBaseEst_1B_W",       #Anova, stepwise
...
Based on analysis of the correlation matrix, we retain all variables except the Tax Base. Next we run a model without Fixed effects and check the VIF scores. We include an interaction term on MHV and fWhite
...
The stepwise procedure identifies a model that includes 7 variables, and interaction term, and fixed effects.
